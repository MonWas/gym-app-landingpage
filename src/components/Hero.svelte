...
<SectionWrapper>
  ...
  >
    <h2
      class="text-fxl sm:text-6xl md:text-7xl lg:text-8xl max-w-[1200px] mx-auto w-full text-center font-semibold"
    >
    ...
    >
      Less thinking, more doing. We're the trainer in you pocket full of <span
        class="italic"
